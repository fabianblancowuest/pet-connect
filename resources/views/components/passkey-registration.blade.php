...
>
    <template x-if="!supported">
        <flux:text>{{ __('Las passkeys no son compatibles con este navegador.') }}</flux:text>
    </template>
    ...
    <template x-if="supported && showForm">
        <div class="space-y-4 rounded-lg border border-zinc-200 dark:border-zinc-700 bg-zinc-50 dark:bg-zinc-800/50 p-4">
            ...
            />
            <flux:text class="!mt-1">{{ __('Dale un nombre a esta passkey para identificarla después.') }}</flux:text>
